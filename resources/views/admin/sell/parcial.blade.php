...
@section('dashboard')
    <div class="mx-3">
        <h3 class="text-center my-3">Recimento Parcial da Venda Nº {{$sell->id}}</h3>
        <table class="table table-striped">
          ...
          <form action="{{route('updateparcial_sell', $sell->id)}}" method="POST">
            @csrf
            <div class="me-3">
            ...
            <div class="mb-3 d-flex w-100 align-items-center gap-5 recebimento p-0">
                <div class="fpag">
            ...
            <div class="date-pay mb-3">
                <label for="date_pay" class="form-label">Data prevista para o restante do pagamento</label>
                <input type="date" name="date_pay" id="date_pay" class="form-control">
            </div>
            
            <button type="submit" class="btn btn-success"><i class="bi bi-check-lg"></i> Finalizar Receb. Parcial</button>
          </form>
    </div>    
@endsection
@section('scripts')
